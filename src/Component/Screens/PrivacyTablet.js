import classes from "../../styles/Privacy_tablet.module.css";
  ...
  return (
    <div className={classes.headerPrivacy}>
      ...
      <div className={classes.titleHeadPrivacy}>
        Orniss Privacy Policy Statement
      </div>
      <div className={classes.dateUpdated}>Last update : Jul 9, 2022</div>
      <div className={classes.shortIntroHead}>
        Thanks for entrusting Orniss with your personal information. Holding
        onto your private information is a serious responsibility, and we want
        you to know how we're handling it.
      </div>
    </div>
  );
};
            ...
            <div className={classes.textPointSingle}>
              ...
              pointText.superTitle === undefined ? (
                <div className={classes.dotContainer}>
                  <FiberManualRecord style={{ fontSize: "2vmin" }} />
                </div>
              ) : null}
              ...
              pointText.subSuperTile === undefined ? (
                ...
                <div className={classes.pointTrueText}>
                  ...
                  <div className={classes.pointContainer2ndForm}>
                    <div className={classes.dotContainer}>
                      <FiberManualRecord
                        style={{ fontSize: "2vmin", opacity: 0 }}
                      />
                    </div>
                    <div className={classes.pointTrueText}>
                      {pointText.text}
    ...
    <div className={classes.container}>
      ...
      <div className={classes.pointsContainer}>
        {showcasePoints(
          ...
          "Introduction",
          [
            "Orniss is a ride-hailing technology platform that, as part of obtaining ride-hail services, enables users (“Users”) of our mobile ride-hail application (the “App”) to arrange rides, deliveries and shopping with independent contractors (“Orniss Partners contractors”). This Privacy Policy applies to Users.",
            "This Privacy Policy applies to Users’ access to and use of the App, websites, content, products and services (collectively, the “ Services ”) made available to Users on or through Orniss’s website at “ www.ornisstechnologies.com ”, which is composed of numerous subsites and webpages operated by Orniss (collectively, the “ Website ”), whether accessed or used via personal computers, mobile devices, or otherwise, provided as part of the Services. In this Privacy Policy, references to “ you ” or “your ” mean Users, including and references to “ Orniss ”, “ we ”, “ us ”, “ our ” refers to Orniss Technologies cc.",
            ...
            "If you have any questions about this Privacy Policy or don’t see your concerns addressed here, you should contact us by email at support@ornisstechnologies.com",
          ],
          null
        )}
        ...
        {showcasePoints(
          4,
          "How we use Orniss users’ personal information",
          [
            "User profile information: We use your profile information for purposes including, but not limited to: (a) creating your account during the registration process, (b) determining your eligibility for a Orniss account, and (c) managing your Orniss account and contacting you about your transactions and other activities on the Website or App.",
        ...
        {showcasePoints(
          ...
          [
            {
              superTitle:
                "Personal information shared with Orniss Partner Drivers",
              text: "We will share your personal information with Orniss Partner Drivers in certain situations. When you are connected with a Orniss Partner Driver for a trip, we will share certain profile information with the Orniss Partner Driver, including your name, picture, contact number, pickup location, destination location, as well as geolocation information.",
            },
            {
              superTitle: "Legal",
        ...
        {showcasePoints(
          ...
          [
            ...
            "While Orniss makes good faith efforts to safeguard your personal information and to secure your data during use of the Services, the Website and/or the App, no transmission of data over the Internet, wireless network, or any other public network can be guaranteed to be 100% secure. In addition, if you are visiting, using or interacting with our Website or the App from a country other than Namibia, your communication with us through the Website or the App will necessarily result in the transfer of information across international boundaries.Orniss cannot ensure or warrant the security of any information that you transmit to us and we do not take any responsibility for any breach that may occur.",
          ],
          null
        )}
        ...
        {showcasePoints(
          ...
          [
            "Users must be at least eighteen (18) years old to use the Services. Orniss does not knowingly collect personal information from children, which we define as individuals under 18 years . If we discover that a child has provided us with personal information, we will immediately delete that child’s personal information. Also, if any parent or guardian of a child is aware that a child has provided us with personal information, we ask that the parent or guardian contact us.",
          ],
          null
        )}
        ...
        {showcasePoints(
          ...
          [
            "You have the right to access and request correction or updating of your personal information in our custody and control, subject to limited exceptions prescribed by applicable laws. You may do so directly by updating your member account profile or by emailing us at support@ornisstechnologies.com",
          ],
          null
        )}
        ...
        {showcasePoints(
          ...
          "How to contact us",
          [
            "If you have any questions, concerns or complaints regarding our Privacy Policy please contact us by email at support@ornisstechnologies.com or via phone at +264856997167.",
          ],
          null
        )}
      </div>
