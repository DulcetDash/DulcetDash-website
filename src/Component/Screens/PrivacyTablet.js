    ...
    <div className={classes.container}>
      ...
      <div className={classes.pointsContainer}>
        {showcasePoints(
          ...
          "Introduction",
          [
            "DulcetDash is a ride-hailing technology platform that, as part of obtaining ride-hail services, enables users (“Users”) of our mobile ride-hail application (the “App”) to arrange rides, deliveries and shopping with independent contractors (“Orniss Partners contractors”). This Privacy Policy applies to Users.",
        ...
        {showcasePoints(
          4,
          "How we use DulcetDash users’ personal information",
          [
            "User profile information: We use your profile information for purposes including, but not limited to: (a) creating your account during the registration process, (b) determining your eligibility for a DulcetDash account, and (c) managing your DulcetDash account and contacting you about your transactions and other activities on the Website or App.",
        ...
        {showcasePoints(
          ...
          [
            ...
            "While DulcetDash makes good faith efforts to safeguard your personal information and to secure your data during use of the Services, the Website and/or the App, no transmission of data over the Internet, wireless network, or any other public network can be guaranteed to be 100% secure. In addition, if you are visiting, using or interacting with our Website or the App from a country other than Namibia, your communication with us through the Website or the App will necessarily result in the transfer of information across international boundaries.DulcetDash cannot ensure or warrant the security of any information that you transmit to us and we do not take any responsibility for any breach that may occur.",
          ],
          null
        )}
        ...
        {showcasePoints(
          ...
          [
            "Users must be at least eighteen (18) years old to use the Services. DulcetDash does not knowingly collect personal information from children, which we define as individuals under 18 years . If we discover that a child has provided us with personal information, we will immediately delete that child’s personal information. Also, if any parent or guardian of a child is aware that a child has provided us with personal information, we ask that the parent or guardian contact us.",
          ],
          null
        )}
        ...
        {showcasePoints(
          ...
          [
            "You have the right to access and request correction or updating of your personal information in our custody and control, subject to limited exceptions prescribed by applicable laws. You may do so directly by updating your member account profile or by emailing us at support@dulcetdash.com",
          ],
          null
        )}
