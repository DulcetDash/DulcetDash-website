import classes from "../styles/TechShowcase_mobile.module.css";
    ...
    <div className={classes.container}>
      ...
      <div>
        <Grid item>
          <div className={classes.containerCard}>
            <div className={classes.imageCardContainer}>
              <Fingerprint style={{ fontSize: "12vmin" }} />
            </div>
        ...
        <Grid item>
          <div className={classes.containerCard}>
            <div className={classes.imageCardContainer}>
              <EmojiPeople style={{ fontSize: "12vmin" }} />
            </div>
...
export default TechShowcaseMobile;
